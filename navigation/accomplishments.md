...
While building the game, I practiced many coding concepts such as object-oriented programming, game loops, event handling, and state management. I learned how to create classes for game objects, implement a game loop to update and render the game state, handle keyboard input for player movement and interactions, and manage different game states such as the boss fight. I also gained experience with debugging techniques, such as using the browser console to identify and fix errors, optimizing performance by adjusting player speed and position, and ensuring that assets loaded correctly. Overall, this sprint helped me better understand game development concepts and improve my coding skills while collaborating with a team to create a functional RPG game. I also gained valuable experience in teamwork and communication, as we had to coordinate our efforts and share ideas to create a cohesive game experience, as well as becoming more efficient at locating bugs, debugging them, and problem-solving, which are essential skills for any developer.

<img src="{{site.baseurl}}/images/about/boss_fight.png" alt="Image 3">
<div class="accomplishments-caption">Our Game</div>
<div class="accomplishments-description">Here is our completed boss fight level. You can move and interact with the boss.</div>
